...
@push('styles')
    ...
    <style>
        ...
        /* Filter Card - Enterprise Styling */
        .filter-card {
    ...
    <div class="container-fluid">
        ...
        <div class="stats-cards animate-in">
            ...
            <div class="stats-card total-credit">
                ...
                <div class="stats-value">{{ number_format($balances->where('type', 'credit')->sum('amount'), 0) }} <small
                        style="font-size: 0.8rem; font-weight: 500;">BDT</small></div>
            ...
            <div class="stats-card total-debit">
                ...
                <div class="stats-value">{{ number_format($balances->where('type', 'debit')->sum('amount'), 0) }} <small
                        style="font-size: 0.8rem; font-weight: 500;">BDT</small></div>
            ...
            <div class="stats-card current-balance">
                ...
                <div class="stats-value">
                    {{ number_format($balances->where('type', 'credit')->sum('amount') - $balances->where('type', 'debit')->sum('amount'), 0) }}
                    <small style="font-size: 0.8rem; font-weight: 500;">BDT</small>
                </div>
        ...
        <!-- Date Filter Card -->
        <div class="filter-card animate-in" style="animation-delay: 0.05s;">
            <div class="filter-header">
                <div class="filter-title-wrapper">
                    ...
                    <div>
                        <h5 class="filter-title">Date Range Filter</h5>
                        <p class="filter-subtitle">Filter transactions by date range</p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="filter-actions">
                        <div class="active-filters">
                            <span class="filter-badge">
                                ...
                                Active Filters:
                                @if(isset($start))
                                    <strong>From {{ \Carbon\Carbon::parse($start)->format('M d, Y') }}</strong>
                                @endif
                                @if(isset($start) && isset($end))
                                    <i class="fas fa-arrow-right mx-2"></i>
                                @endif
                                @if(isset($end))
                                    <strong>To {{ \Carbon\Carbon::parse($end)->format('M d, Y') }}</strong>
                                @endif
                            </span>
                        </div>
                        <a href="/merchant/balance/details" class="btn btn-outline-secondary btn-sm btn-clear">
