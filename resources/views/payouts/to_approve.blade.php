...
<div class="container-fluid">
    ...
    <div class="page-header">
        <h2><i class="fas fa-check-double me-3"></i>Payouts Ready for Maker Approval</h2>
        <p class="mb-0 opacity-90">Review and approve or reject payout batches that have been checked and verified</p>
    </div>
    ...
    <div class="table-card">
                    ...
                    <tbody>
                        @foreach($payouts as $payout)
                            <tr>
                                ...
                                <td><span class="badge bg-secondary">{{ $payout->count }}</span></td>
        ...
        @else
            <div class="empty-state">
                ...
                <h5>No Checked Batches</h5>
                <p class="mb-0">There are no payout batches ready for maker approval at the moment.</p>
            </div>
        @endif
    </div>
</div>
