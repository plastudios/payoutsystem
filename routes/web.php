...
Route::get('/dashboard', function () {
    ...
    if ($user->role === 'merchant') {
        ...
        return view('dashboard', compact(
            'successCount', 'failedCount', 'successAmount', 'failedAmount',
            'availableBalance', 'credit', 'debit', 'mfsSuccessCount', 'mfsFailedCount'
        ));
    }
    ...
    return view('dashboard', compact(
        'successCount', 'failedCount', 'successAmount', 'failedAmount',
        'totalMerchants', 'totalAllocated', 'mfsSuccessCount', 'mfsFailedCount'
    ));
})->middleware('auth');
